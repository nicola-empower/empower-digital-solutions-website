...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_TQ2aKO9n.mjs';
import { manifest } from './manifest_C-KNDpmJ.mjs';
...
const _page27 = () => import('./pages/terms.astro.mjs');
const _page28 = () => import('./pages/vaassist.astro.mjs');
const _page29 = () => import('./pages/web-design.astro.mjs');
const _page30 = () => import('./pages/website-health-checker.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/terms.astro", _page27],
    ["src/pages/vaassist.astro", _page28],
    ["src/pages/web-design.astro", _page29],
    ["src/pages/website-health-checker.astro", _page30],
...
const _args = {
    "middlewareSecret": "1d1589e2-fb85-4c1f-9003-bae174e5431b",
