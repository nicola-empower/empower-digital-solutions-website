...
const POST = async ({ request }) => {
  try {
    ...
    const apiKey = "AIzaSyBYgIS7LS25-QxaMhD5O64VE-gnPSn6lx0";
    if (!apiKey) ;
    ...
    const metrics = {
      ...
      // FID is deprecated, using Max Potential FID as proxy or TBT
      speedIndex: lighthouse.audits["speed-index"].displayValue
    };
    let aiInsight = "AI analysis unavailable at this time.";
    const geminiKey = "AIzaSyBJiXvvMPs_xNGBXF4ZPYIKRaoEZCIq-qA";
